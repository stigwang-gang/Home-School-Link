...
CREATE TABLE `category`  (
  ...
  `categoryName` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `class_schedule`  (
  ...
  `classLength` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`, `CCT_id`) USING BTREE,
  INDEX `class_schedule_CCT_id`(`CCT_id`) USING BTREE,
  CONSTRAINT `class_schedule_CCT_id` FOREIGN KEY (`CCT_id`) REFERENCES `classbean_commodity_teacher` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `classbean`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `classBeanName` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `classbean_commodity_teacher`  (
  ...
  PRIMARY KEY (`id`, `classBean_id`, `commodity_id`, `teacher_id`) USING BTREE,
  INDEX `classBean_id`(`classBean_id`) USING BTREE,
  INDEX `commodity_id`(`commodity_id`) USING BTREE,
  INDEX `teacher_id`(`teacher_id`) USING BTREE,
  INDEX `id`(`id`) USING BTREE,
  CONSTRAINT `classBean_id` FOREIGN KEY (`classBean_id`) REFERENCES `classbean` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `commodity_id` FOREIGN KEY (`commodity_id`) REFERENCES `commodity` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
-- ----------------------------
INSERT INTO `commodity` VALUES (1, '微积分', '其他', '微积分', '2021-07-10 15:01:28', '/uploadImages/03cb4355-9f2a-4c78-a6f8-6a8e6a313823_高一语文.jpg');
INSERT INTO `commodity` VALUES (2, '英语', '其他', '英语', '2021-07-10 07:49:09', '/uploadImages/b9804f14-ed06-456a-b954-7cfd0c9c8751_高一英语.jpg');
INSERT INTO `commodity` VALUES (3, '概率论', '其他', '概率论', '2021-07-10 15:01:44', '/uploadImages/07d19d96-5f9e-4391-9a0d-24142f4a27be_高一数学.jpg');
INSERT INTO `commodity` VALUES (4, '体育', '其他', '体育', '2021-07-10 07:49:30', '/uploadImages/e1d4f461-82df-42c4-9a18-4f456325de45_体育.jpg');
INSERT INTO `commodity` VALUES (5, '大物', '理科', '大物', '2021-07-10 15:01:44', '/uploadImages/22016dcf-bd08-42b5-b6e4-8f48c92aeb3e_高一物理.jpg');
INSERT INTO `commodity` VALUES (6, '数据结构', '理科', '数据结构', '2021-07-10 15:01:44', '/uploadImages/7526d513-024b-4b20-8f16-7a4e95a92534_高一生物.jpg');
INSERT INTO `commodity` VALUES (7, '计算机网络', '理科', '计算机网络', '2021-07-10 15:01:44', '/uploadImages/cd2a2624-b934-44be-832f-57773d6fad7c_高一化学.jpg');
INSERT INTO `commodity` VALUES (8, '数字逻辑', '文科', '数字逻辑', '2021-07-10 15:01:44', '/uploadImages/8d9f4ea5-bab6-4428-bc4d-ca9d2412950d_高一历史.jpg');
INSERT INTO `commodity` VALUES (9, '模拟电路', '文科', '模拟电路', '2021-07-10 15:01:44', '/uploadImages/6aa0289a-c968-499b-94bd-8bf13fdc37cc_高一地理.jpg');
INSERT INTO `commodity` VALUES (10, '中国近代史', '文科', '中国近代史', '2021-07-10 15:01:44', '/uploadImages/ccd68b7f-4a76-4cf8-8808-c48fc22b8e4b_高一政治.jpg');
INSERT INTO `commodity` VALUES (11, '音乐鉴赏', '其他', '音乐鉴赏', '2021-07-10 15:01:44', NULL);
INSERT INTO `commodity` VALUES (12, '美术鉴赏', '其他', '美术鉴赏', '2021-07-10 15:01:44', NULL);
INSERT INTO `commodity` VALUES (13, '计算机组成', '其他', '计算机组成', '2021-07-10 15:01:44', NULL);
...
CREATE TABLE `homework`  (
  ...
  `H_name` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `H_content` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `H_startTime` datetime NULL DEFAULT NULL,
  `H_endTime` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`H_ID`) USING BTREE,
  INDEX `H_name`(`H_name`) USING BTREE
...
CREATE TABLE `parent`  (
  ...
  `parentName` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `profession` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `workspace` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `parent_student_id`(`student_id`) USING BTREE,
  CONSTRAINT `parent_student_id` FOREIGN KEY (`student_id`) REFERENCES `student` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `student`  (
  ...
  `idNumber` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `gender` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `enrollyear` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `classNum`(`classNum`) USING BTREE,
  INDEX `idCard`(`idCard`) USING BTREE,
  CONSTRAINT `classNum` FOREIGN KEY (`classNum`) REFERENCES `classbean` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `student_commodity`  (
  ...
  PRIMARY KEY (`id`, `student_id`, `commodity_id`) USING BTREE,
  INDEX `student_id`(`student_id`) USING BTREE,
  INDEX `commodity_id`(`commodity_id`) USING BTREE,
  CONSTRAINT `student_commodity_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `student_commodity_ibfk_2` FOREIGN KEY (`commodity_id`) REFERENCES `commodity` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `student_homework`  (
  ...
  `grade` double(11, 0) NULL DEFAULT NULL,
  `isDone` int(11) NULL DEFAULT 0,
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `wordFilePath` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`, `student_id`, `H_ID`) USING BTREE,
  INDEX `student_homework_student_id`(`student_id`) USING BTREE,
  INDEX `student_homework_H_ID`(`H_ID`) USING BTREE,
  CONSTRAINT `student_homework_H_ID` FOREIGN KEY (`H_ID`) REFERENCES `homework` (`H_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `student_homework_student_id` FOREIGN KEY (`student_id`) REFERENCES `student` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `teacher`  (
  ...
  `userName` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `password` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `teacherName` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `teacher_commodity_homework`  (
  ...
  `commodity_id` int(11) NOT NULL DEFAULT 0,
  `teacher_id` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`, `H_ID`, `commodity_id`, `teacher_id`) USING BTREE,
  INDEX `H_ID`(`H_ID`) USING BTREE,
  INDEX `commodity_homework_commodity_id`(`commodity_id`) USING BTREE,
  INDEX `commodity_homework_teacher_teacher_id`(`teacher_id`) USING BTREE,
  CONSTRAINT `commodity_homework_commodity_id` FOREIGN KEY (`commodity_id`) REFERENCES `commodity` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `commodity_homework_teacher_teacher_id` FOREIGN KEY (`teacher_id`) REFERENCES `teacher` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `H_ID` FOREIGN KEY (`H_ID`) REFERENCES `homework` (`H_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT
